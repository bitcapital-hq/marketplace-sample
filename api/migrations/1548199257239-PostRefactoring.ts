...
export class PostRefactoring1548199257239 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(
      `CREATE TABLE "extract" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "totalValue" integer NOT NULL, "quantity" integer NOT NULL, "customerId" uuid NOT NULL, "sellerId" uuid NOT NULL, "storageId" uuid NOT NULL, CONSTRAINT "PK_ec7cded7d354e84ca36012379cc" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `ALTER TABLE "storage" ADD CONSTRAINT "FK_4aeb602026a5b626544c51eb407" FOREIGN KEY ("ownerId") REFERENCES "user"("id")`
    );
    await queryRunner.query(
      `ALTER TABLE "storage" ADD CONSTRAINT "FK_1f0ff4e5ad959c1050534857ea9" FOREIGN KEY ("productId") REFERENCES "product"("id")`
    );
    await queryRunner.query(
      `ALTER TABLE "extract" ADD CONSTRAINT "FK_0f7de9dc9f31b0e80ffcd56376c" FOREIGN KEY ("customerId") REFERENCES "user"("id") ON DELETE RESTRICT`
    );
    await queryRunner.query(
      `ALTER TABLE "extract" ADD CONSTRAINT "FK_8109186d3756a1be97d6e433d45" FOREIGN KEY ("sellerId") REFERENCES "user"("id") ON DELETE RESTRICT`
    );
    await queryRunner.query(
      `ALTER TABLE "extract" ADD CONSTRAINT "FK_6c114b1877e109f0743b86c8d3f" FOREIGN KEY ("storageId") REFERENCES "storage"("id") ON DELETE RESTRICT`
    );
  }
