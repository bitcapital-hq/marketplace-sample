...
export default class DocumentService extends Service {
  ...
  public async setDocumentForUser(id: string, photoBase64: string) {
    ...
    if (user == null) {
      throw new BaseError("Cannot find user with id", { id });
    }
    ...
    const document = await bitcapitalClient
      .consumers()
      .uploadDocumentPictureFromBase64(user.bitcapitalId, DocumentType.BRL_IDENTITY, "front", photoBase64);
